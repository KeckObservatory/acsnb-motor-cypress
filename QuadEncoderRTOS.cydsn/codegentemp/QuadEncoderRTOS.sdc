...
# Date: Fri, 08 Sep 2023 22:07:57 GMT
#set_units -time ns
...
create_clock -name {Encoder_Clock(FFB)} -period 41.666666666666664 -waveform {0 20.8333333333333} [list [get_pins {ClockBlock/ff_div_10}]]
...
create_generated_clock -name {Encoder_Clock} -source [get_pins {ClockBlock/hfclk}] -edges {1 3 5} [list [get_pins {ClockBlock/udb_div_0}]]
...
# Project: C:\Users\prichards\proj\acsnb-motor-cypress\QuadEncoderRTOS.cydsn\QuadEncoderRTOS.cyprj
# Date: Fri, 08 Sep 2023 22:07:54 GMT
