...
module top ;
    ...
    assign Net_482 = cydff_6;
    // -- DFF End --

	wire [0:0] tmpOE__INDEX_OUT_net;
	wire [0:0] tmpFB_0__INDEX_OUT_net;
	wire [0:0] tmpIO_0__INDEX_OUT_net;
	wire [0:0] tmpINTERRUPT_0__INDEX_OUT_net;
	electrical [0:0] tmpSIOVREF__INDEX_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("43350a40-d888-478b-8fd0-bedad5e90190"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		INDEX_OUT
		 (.oe(tmpOE__INDEX_OUT_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__INDEX_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INDEX_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__INDEX_IN_net;
	wire [0:0] tmpIO_0__INDEX_IN_net;
	wire [0:0] tmpINTERRUPT_0__INDEX_IN_net;
	electrical [0:0] tmpSIOVREF__INDEX_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("b6895dba-9b90-4e6d-a5aa-2087fac91f7c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__INDEX_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HOME_OUT_net;
	wire [0:0] tmpFB_0__HOME_OUT_net;
	wire [0:0] tmpIO_0__HOME_OUT_net;
	wire [0:0] tmpINTERRUPT_0__HOME_OUT_net;
	electrical [0:0] tmpSIOVREF__HOME_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("915683a2-e2a9-4915-8ac9-0695d1c46c08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HOME_OUT
		 (.oe(tmpOE__HOME_OUT_net),
		  .y({Net_648}),
		  .fb({tmpFB_0__HOME_OUT_net[0:0]}),
		  .io({tmpIO_0__HOME_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__HOME_OUT_net),
		  .interrupt({tmpINTERRUPT_0__HOME_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOME_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 TP_8 (
        .connect({
            SDA
        })
    );
    defparam TP_8.comp_name = "TestPoint_v1_0";
    defparam TP_8.port_names = "T1";
    defparam TP_8.width = 1;

    cy_annotation_universal_v1_0 TP_9 (
        .connect({
            SCL
        })
    );
    defparam TP_9.comp_name = "TestPoint_v1_0";
    defparam TP_9.port_names = "T1";
    defparam TP_9.width = 1;
	...
	wire [0:0] tmpOE__HOME_IN_net;
	wire [0:0] tmpIO_0__HOME_IN_net;
	electrical [0:0] tmpSIOVREF__HOME_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("61ba33cc-f846-4389-b365-a573ba688ccf"),
		  ...
		  .input_buffer_sel(2'b00))
		HOME_IN
		 (.oe(tmpOE__HOME_IN_net),
		  .y({1'b0}),
		  .fb({Net_648}),
		  .io({tmpIO_0__HOME_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__HOME_IN_net),
		  .interrupt({Net_647}),
		  .annotation({Net_2336}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__HOME_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("07ca8e22-caf3-4994-927e-6d27188020dc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Reset_Encoder_net;
	wire [0:0] tmpIO_0__Reset_Encoder_net;
	electrical [0:0] tmpSIOVREF__Reset_Encoder_net;
	...
	assign tmpOE__Reset_Encoder_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7ceddc74-f93a-4ca9-aab7-a3c1eb12acd9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    // -- DFF Start --
    reg  cydff_7;
    always @(posedge Net_479)
    begin
        cydff_7 <= Net_482;
    end
    assign Net_2344 = cydff_7;
    // -- DFF End --
    ...
    assign Net_628 = Net_630 & Net_644;


    assign Net_629 = Net_644 & Net_634;


    assign Net_625 = ~Net_648;
	...
	cy_psoc3_pins_v1_10
		#(.id("20b2e241-8805-4a26-8b90-0e9f839ef849"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f56a0c0f-832a-4d0a-8b8e-d81edffc6e36"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("953a227e-7740-429c-8a2a-d849ee1cea4f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("88da7a03-3ce7-4fb7-badc-aec021f74a01"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d5a91840-d314-4159-8286-cda8779a928d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PROBE_net;
	wire [0:0] tmpFB_0__PROBE_net;
	wire [0:0] tmpIO_0__PROBE_net;
	wire [0:0] tmpINTERRUPT_0__PROBE_net;
	electrical [0:0] tmpSIOVREF__PROBE_net;

	cy_psoc3_pins_v1_10
		#(.id("c0188285-e1f3-4a8b-83c9-6a40e68ea3dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PROBE
		 (.oe(tmpOE__PROBE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PROBE_net[0:0]}),
		  .io({tmpIO_0__PROBE_net[0:0]}),
		  .siovref(tmpSIOVREF__PROBE_net),
		  .interrupt({tmpINTERRUPT_0__PROBE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PROBE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
