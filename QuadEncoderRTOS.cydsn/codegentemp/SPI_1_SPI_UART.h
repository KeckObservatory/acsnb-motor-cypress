...
#define SPI_1_SPI_CLOCK_MODE             (2u)
#define SPI_1_SPI_OVS_FACTOR             (16u)
#define SPI_1_SPI_MEDIAN_FILTER_ENABLE   (1u)
...
#define SPI_1_SPI_RX_BUFFER_SIZE         (32u)
#define SPI_1_SPI_TX_BUFFER_SIZE         (32u)

#define SPI_1_SPI_INTERRUPT_MODE         (1u)

#define SPI_1_SPI_INTR_RX_MASK           (0x4u)
#define SPI_1_SPI_INTR_TX_MASK           (0x0u)

#define SPI_1_SPI_RX_TRIGGER_LEVEL       (7u)
#define SPI_1_SPI_TX_TRIGGER_LEVEL       (4u)
